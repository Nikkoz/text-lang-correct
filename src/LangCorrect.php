...
class LangCorrect
{
    ...
    /**
     * Флаг для использования первых двух парметров вместе
     */
    const FIX_LAYOUT = 3;
	...
	*/
     ...
     */
    public function __construct(int $minLength = 4, array $words_exceptions = null)
    {
        ...
        if (!empty($a[1]) && !empty($a[2])) {
			...
			*/
            ...
            if (
                ...
                #фамилия по-русски?
                if (
                preg_match('/^ (?:' . $this->tt_uc . ')   #первая буква д.б. большая
            ...
            if (
                ...
                #фамилия по-англ.?
                if (
                preg_match('/^ ' . $this->en_uc . '  #первая буква д.б. большая
    ...
    private function _bigram_exists($word, $lang)
    {
        ...
        if (
            preg_match('/(?:' . $this->consonant_lc[$lang] . '){4}/sxSX', $word, $m)
        ...
        if (
            preg_match('/(?:' . $this->vowel_lc[$lang] . '){3}/sxSX', $word, $m)
            #проверяем список исключений
